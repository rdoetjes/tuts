...
### 🔹 Bitwise Operations  
Students will learn how operators like **AND**, **OR**, **XOR**, **NOT**, and bit shifting are used to manipulate binary data. These examples show how bitwise logic forms the foundation of low-level computing and networking.
